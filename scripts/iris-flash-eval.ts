...
const PROMPT = [
  ...
  '',
  'WINDOW = the LAST 3 DAYS (since 2026-06-22), across ALL sources — IGNORE the saved cursors for this eval and use the date window instead:',
  '- Slack: search.messages with `after:2026-06-22` (sort=timestamp); honor the ignore-list; normal triage.',
  '- Jira: the 4 boards with their normal per-board JQL but `updated >= "2026-06-22"`.',
